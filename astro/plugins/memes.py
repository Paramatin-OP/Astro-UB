...
from astro.astroConfig import Var
from astro.utils import admin_cmd, register
...
@astro.on(admin_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
...
@astro.on(admin_cmd(outgoing=True, pattern=":/"))
async def kek(keks):
...
@astro.on(admin_cmd(outgoing=True, pattern=r"coinflip (.*)"))
async def _(event):
...
@astro.on(admin_cmd(pattern="slap(?: |$)(.*)", outgoing=True))
async def who(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
...
@astro.on(admin_cmd(outgoing=True, pattern="decide"))
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        if event.fwd_from:
            return
...
@astro.on(admin_cmd(outgoing=True, pattern="cry"))
async def cry(e):
...
@astro.on(admin_cmd(outgoing=True, pattern="insult"))
async def insult(e):
    """ I make you cry !! """
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@astro.on(admin_cmd(outgoing=True, pattern="cp(?: |$)(.*)"))
...
@astro.on(admin_cmd(outgoing=True, pattern="vapor(?: |$)(.*)"))
async def vapor(vpr):
    """ Vaporize everything! """
...
@astro.on(admin_cmd(outgoing=True, pattern="repo"))
...
@astro.on(admin_cmd(outgoing=True, pattern="str(?: |$)(.*)"))
...
@astro.on(admin_cmd(outgoing=True, pattern="zal(?: |$)(.*)"))
async def zal(zgfy):
...
@astro.on(admin_cmd(outgoing=True, pattern="hi"))
async def hoi(hello):
    """ Greet everyone! """
...
@astro.on(admin_cmd(pattern=r"hi2"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit("🌺✨✨🌺✨🌺🌺🌺\n🌺✨✨🌺✨✨🌺✨\n🌺🌺🌺🌺✨✨🌺✨\n🌺✨✨🌺✨✨🌺✨\n🌺✨✨🌺✨🌺🌺🌺\n☁☁☁☁☁☁☁☁")
...
@astro.on(admin_cmd(outgoing=True, pattern="kill"))
