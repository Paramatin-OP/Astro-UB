...
#Import Gudz
RUN wget https://raw.githubusercontent.com/PsychoBots/Astro-UB/blob/psycho/requirements.txt
RUN wget https://raw.githubusercontent.com/PsychoBots/Astro-UB/blob/psycho/Astrorun.py
#Start Fumkin
